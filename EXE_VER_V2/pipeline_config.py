...
from runtime_paths import CODE_DIR, OUTPUT_ROOT, PROJECT_ROOT


DEFAULT_OUTPUT_ROOT = OUTPUT_ROOT
DEFAULT_ORTHOMOSAIC = PROJECT_ROOT / "ACT2025_RGB_75mm_ortho__Urambi_Clip.tif"
DEFAULT_MODEL_ROOT = CODE_DIR / "models"
DEFAULT_LOCAL_ONNX_FOLDER = DEFAULT_MODEL_ROOT / "rfdetr_large_onnx"
DEFAULT_LOCAL_PT_MODEL = DEFAULT_MODEL_ROOT / "yolo_pt" / "best.pt"
DEFAULT_LOCAL_MODEL = DEFAULT_LOCAL_ONNX_FOLDER / "weights.onnx"
...
class DetectionConfig:
    ...
    inference_backend: str = "local_yolo"
    local_model_source: str = "onnx_folder"
    local_onnx_folder: Path = DEFAULT_LOCAL_ONNX_FOLDER
    local_pt_model: Path = DEFAULT_LOCAL_PT_MODEL
