...
def _format_run_summary(
    ...
    if detection_result:
        lines.extend(
            [
                f"  - Raw rock detections: {detection_result.raw_detection_count}",
                f"  - Rocks detected after NMS: {detection_result.final_detection_count}",
                f"  - Green-filter removed: {detection_result.green_filtered_count}",
                f"  - Rock detection file: {detection_result.output_shp}",
            ]
        )
